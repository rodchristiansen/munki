...
This document tracks the differences between our internal fork (`example-org/munki`) and the upstream repository (`rodchristiansen/munki`).

## Repository Overview

*   **Upstream**: `https://github.com/rodchristiansen/munki` (Branch: `main`)
*   **Internal**: `https://github.com/example-org/munki` (Branch: `main`)
